...
def get_config(config_str='B-eval-single'):
  ...
  if 'eval' in options:
    ...
    config.eval_from.checkpoint_path = '/scratch/bae9wk/magvit/workdir/checkpoint_105520'
    # {
    ...
    config.eval.results_dir = '/scratch/bae9wk/magvit/workdir/eval'
